...
int hello_init(void)                                                              
{
	...
	if (threadControle_1A == NULL) 
	{
		printf("Não foi possivel criar a Thread deste PWM.\n\n");
		return(NULL);
	}
	
	if(pthread_create(threadControle_1A, NULL, upSignalA_Thread, NULL))
	{
	...
	if (threadControle_2A == NULL) 
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(NULL);
	}

	if(pthread_create(threadControle_2A, NULL, downSignalA_Thread, NULL))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(NULL);
	}
	...
	if (threadControle_1B == NULL) 
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(NULL);
	}

	if(pthread_create(threadControle_1B, NULL, upSignalB_Thread, NULL))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(NULL);
	}
	...
	if (threadControle_2B == NULL) 
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(NULL);
	}

	if(pthread_create(threadControle_2B, NULL, downSignalB_Thread, NULL))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(NULL);
	}
