...
int main(void)
{
	...
	if (threadControle_11 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n\n");
		return(0);
	}

	if(pthread_create(threadControle_11, 0, signalIchi, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n");
		return(0);
	}
	threadControle_12 = (pthread_t *) malloc(sizeof(pthread_t));
	if (threadControle_12 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n\n");
		return(0);
	}

	if(pthread_create(threadControle_12, 0, signalIchi, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n");
		return(0);
	}
	threadControle_13 = (pthread_t *) malloc(sizeof(pthread_t));
	if (threadControle_13 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n\n");
		return(0);
	}

	if(pthread_create(threadControle_13, 0, signalIchi, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n");
		return(0);
	}
	...
	if (threadControle_21 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(0);
	}

	if(pthread_create(threadControle_21, 0, signalNi, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(0);
	}
	threadControle_22 = (pthread_t *) malloc(sizeof(pthread_t));
	if (threadControle_22 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(0);
	}

	if(pthread_create(threadControle_22, 0, signalNi, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(0);
	}
	...
	if (threadControle_31 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(0);
	}

	if(pthread_create(threadControle_31, 0, signalSan, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(0);
	}
	threadControle_32 = (pthread_t *) malloc(sizeof(pthread_t));
	if (threadControle_32 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(0);
	}

	if(pthread_create(threadControle_32, 0, signalSan, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(0);
	}
	threadControle_33 = (pthread_t *) malloc(sizeof(pthread_t));
	if (threadControle_33 == 0)
	{
		printf("Não foi possivel criar a Thread deste PWM.\n");
		return(0);
	}

	if(pthread_create(threadControle_33, 0, signalSan, 0))
	{
		printf("Não escalonar a Thread deste PWM.\n\n");
		return(0);
	}
